...
/**
 * get_history_file - gets a history file
 * @info: a parameter struct
 *
 * Return: the allocated string containg a history file
 */
...
/**
 * write_history - creates the file, or appends to another existing file
